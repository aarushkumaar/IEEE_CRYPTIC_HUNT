...
=======
var commonFa1cc002_node = require('./common-ebc88bf6.node.cjs.js');
var util = require('@firebase/util');
require('crypto');
...
=======
            commonFa1cc002_node.logDebug(LOG_TAG$1, `Backing off for ${remainingDelayMs} ms ` +
>>>>>>> Stashed changes
...
=======
function registerFirestore() {
    commonFa1cc002_node.setSDKVersion(`${app.SDK_VERSION}_lite`);
    app._registerComponent(new component.Component('firestore/lite', (container, { instanceIdentifier: databaseId, options: settings }) => {
        const app = container.getProvider('app').getImmediate();
        const firestoreInstance = new commonFa1cc002_node.Firestore(new commonFa1cc002_node.LiteAuthCredentialsProvider(container.getProvider('auth-internal')), new commonFa1cc002_node.LiteAppCheckTokenProvider(app, container.getProvider('app-check-internal')), commonFa1cc002_node.databaseIdFromApp(app, databaseId), app);
>>>>>>> Stashed changes
        if (settings) {
...
=======
    ...
    _fieldsProto() {
        ...
        const dataClone = new commonFa1cc002_node.ObjectValue({
...
=======
    const firestore = commonFa1cc002_node.cast(query.firestore, commonFa1cc002_node.Firestore);
    const datastore = commonFa1cc002_node.getDatastore(firestore);
    const internalAggregates = commonFa1cc002_node.mapToArray(aggregateSpec, (aggregate, alias) => {
        return new AggregateImpl(alias, aggregate.aggregateType, aggregate._internalFieldPath);
    });
    // Run the aggregation and convert the results
    return commonFa1cc002_node.invokeRunAggregationQueryRpc(datastore, query._query, internalAggregates).then(aggregateResult => convertToAggregateQuerySnapshot(firestore, query, aggregateResult));
}
function convertToAggregateQuerySnapshot(firestore, query, aggregateResult) {
    const userDataWriter = new commonFa1cc002_node.LiteUserDataWriter(firestore);
>>>>>>> Stashed changes
 ...
 */
function sum(field) {
    return new AggregateField('sum', commonFa1cc002_node.fieldPathFromArgument('sum', field));
>>>>>>> Stashed changes
}
/**
 ...
 */
function average(field) {
    return new AggregateField('avg', commonFa1cc002_node.fieldPathFromArgument('average', field));
>>>>>>> Stashed changes
}
/**
...
function vector(values) {
    return new VectorValue(values);
=======
    return (commonFa1cc002_node.queryEqual(left.query, right.query) && util.deepEqual(left.data(), right.data()));
>>>>>>> Stashed changes
}
...
=======
        this._dataReader = commonFa1cc002_node.newUserDataReader(_firestore);
>>>>>>> Stashed changes
    }
...
=======
        const convertedValue = commonFa1cc002_node.applyFirestoreDataConverter(ref.converter, data, options);
        const parsed = commonFa1cc002_node.parseSetData(this._dataReader, 'WriteBatch.set', ref._key, convertedValue, ref.converter !== null, options);
        this._mutations.push(parsed.toMutation(ref._key, commonFa1cc002_node.Precondition.none()));
>>>>>>> Stashed changes
        return this;
    }
...
=======
            fieldOrUpdateData instanceof commonFa1cc002_node.FieldPath) {
            parsed = commonFa1cc002_node.parseUpdateVarargs(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = commonFa1cc002_node.parseUpdateData(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData);
        }
        this._mutations.push(parsed.toMutation(ref._key, commonFa1cc002_node.Precondition.exists(true)));
>>>>>>> Stashed changes
        return this;
    }
    /**
...
=======
        this._mutations = this._mutations.concat(new commonFa1cc002_node.DeleteMutation(ref._key, commonFa1cc002_node.Precondition.none()));
>>>>>>> Stashed changes
        return this;
    }
    /**
...
=======
            throw new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.FAILED_PRECONDITION, 'A write batch can no longer be used after commit() ' +
>>>>>>> Stashed changes
                'has been called.');
        }
    }
...
=======
        throw new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.INVALID_ARGUMENT, 'Provided document reference is from a different Firestore instance.');
>>>>>>> Stashed changes
    }
    else {
        return documentRef;
...
=======
    firestore = commonFa1cc002_node.cast(firestore, commonFa1cc002_node.Firestore);
    const datastore = commonFa1cc002_node.getDatastore(firestore);
    return new WriteBatch(firestore, writes => commonFa1cc002_node.invokeCommitRpc(datastore, writes));
>>>>>>> Stashed changes
}
...
=======
        throw new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.INVALID_ARGUMENT, 'Max attempts must be at least 1');
>>>>>>> Stashed changes
    }
}
...
=======
            this.lastTransactionError = new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.INVALID_ARGUMENT, 'Firestore transactions require all reads to be executed before all writes.');
            throw this.lastTransactionError;
        }
        const docs = await commonFa1cc002_node.invokeBatchGetDocumentsRpc(this.datastore, keys);
>>>>>>> Stashed changes
...
=======
        this.write(new commonFa1cc002_node.DeleteMutation(key, this.precondition(key)));
>>>>>>> Stashed changes
        this.writtenDocs.add(key.toString());
    }
    async commit() {
...
=======
            const key = commonFa1cc002_node.DocumentKey.fromPath(path);
            this.mutations.push(new commonFa1cc002_node.VerifyMutation(key, this.precondition(key)));
        });
        await commonFa1cc002_node.invokeCommitRpc(this.datastore, this.mutations);
>>>>>>> Stashed changes
        this.committed = true;
    }
    recordVersion(doc) {
...
<<<<<<< Updated upstream
            ...
            throw fail();
=======
            docVersion = commonFa1cc002_node.SnapshotVersion.min();
        }
        else {
            throw commonFa1cc002_node.fail(0xc542, {
...
=======
                throw new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.ABORTED, 'Document version changed between two reads.');
>>>>>>> Stashed changes
            }
        }
        else {
...
=======
            if (version.isEqual(commonFa1cc002_node.SnapshotVersion.min())) {
                return commonFa1cc002_node.Precondition.exists(false);
            }
            else {
                return commonFa1cc002_node.Precondition.updateTime(version);
            }
        }
        else {
            return commonFa1cc002_node.Precondition.none();
>>>>>>> Stashed changes
        }
    }
    /**
...
<<<<<<< Updated upstream
            ...
            return Precondition.updateTime(version);
=======
                throw new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
            }
            // Document exists, base precondition on document update time.
            return commonFa1cc002_node.Precondition.updateTime(version);
>>>>>>> Stashed changes
...
=======
            return commonFa1cc002_node.Precondition.exists(true);
>>>>>>> Stashed changes
        }
    }
    write(mutation) {
...
=======
            if (commonFa1cc002_node.isNullOrUndefined(userPromise) ||
>>>>>>> Stashed changes
                !userPromise.catch ||
                !userPromise.then) {
...
=======
                !commonFa1cc002_node.isPermanentError(code));
>>>>>>> Stashed changes
        }
        return false;
    }
...
=======
            this.deferred.reject(new commonFa1cc002_node.FirestoreError(commonFa1cc002_node.Code.CANCELLED, 'Operation cancelled' + (reason ? ': ' + reason : '')));
>>>>>>> Stashed changes
        }
    }
    handleDelayElapsed() {
...
=======
                commonFa1cc002_node.logDebug(LOG_TAG, 'Operation failed with retryable error: ' + e);
>>>>>>> Stashed changes
            }
            else {
...
=======
                commonFa1cc002_node.logError('INTERNAL UNHANDLED ERROR: ', message);
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
            fail();
=======
            commonFa1cc002_node.fail(0xb815, {
...
<<<<<<< Updated upstream
        ...
        return this._transaction.lookup([ref._key]).then(docs => {
            ...
            if (doc.isFoundDocument()) {
                ...
                throw fail();
=======
        const userDataWriter = new commonFa1cc002_node.LiteUserDataWriter(this._firestore);
        return this._transaction.lookup([ref._key]).then(docs => {
            if (!docs || docs.length !== 1) {
                return commonFa1cc002_node.fail(0x5de9);
            }
            const doc = docs[0];
            if (doc.isFoundDocument()) {
                return new commonFa1cc002_node.DocumentSnapshot(this._firestore, userDataWriter, doc.key, doc, ref.converter);
            }
            else if (doc.isNoDocument()) {
                return new commonFa1cc002_node.DocumentSnapshot(this._firestore, userDataWriter, ref._key, null, ref.converter);
            }
            else {
                throw commonFa1cc002_node.fail(0x4801, {
                    doc
                });
>>>>>>> Stashed changes
            }
...
=======
        const convertedValue = commonFa1cc002_node.applyFirestoreDataConverter(ref.converter, value, options);
        const parsed = commonFa1cc002_node.parseSetData(this._dataReader, 'Transaction.set', ref._key, convertedValue, ref.converter !== null, options);
>>>>>>> Stashed changes
...
=======
            fieldOrUpdateData instanceof commonFa1cc002_node.FieldPath) {
            parsed = commonFa1cc002_node.parseUpdateVarargs(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = commonFa1cc002_node.parseUpdateData(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData);
>>>>>>> Stashed changes
        }
...
exports.where = where;
=======
exports.Bytes = commonFa1cc002_node.Bytes;
exports.CollectionReference = commonFa1cc002_node.CollectionReference;
exports.DocumentReference = commonFa1cc002_node.DocumentReference;
exports.DocumentSnapshot = commonFa1cc002_node.DocumentSnapshot;
exports.FieldPath = commonFa1cc002_node.FieldPath;
exports.FieldValue = commonFa1cc002_node.FieldValue;
exports.Firestore = commonFa1cc002_node.Firestore;
exports.FirestoreError = commonFa1cc002_node.FirestoreError;
exports.GeoPoint = commonFa1cc002_node.GeoPoint;
exports.Query = commonFa1cc002_node.Query;
exports.QueryCompositeFilterConstraint = commonFa1cc002_node.QueryCompositeFilterConstraint;
exports.QueryConstraint = commonFa1cc002_node.QueryConstraint;
exports.QueryDocumentSnapshot = commonFa1cc002_node.QueryDocumentSnapshot;
exports.QueryEndAtConstraint = commonFa1cc002_node.QueryEndAtConstraint;
exports.QueryFieldFilterConstraint = commonFa1cc002_node.QueryFieldFilterConstraint;
exports.QueryLimitConstraint = commonFa1cc002_node.QueryLimitConstraint;
exports.QueryOrderByConstraint = commonFa1cc002_node.QueryOrderByConstraint;
exports.QuerySnapshot = commonFa1cc002_node.QuerySnapshot;
exports.QueryStartAtConstraint = commonFa1cc002_node.QueryStartAtConstraint;
exports.Timestamp = commonFa1cc002_node.Timestamp;
exports.VectorValue = commonFa1cc002_node.VectorValue;
exports.addDoc = commonFa1cc002_node.addDoc;
exports.and = commonFa1cc002_node.and;
exports.arrayRemove = commonFa1cc002_node.arrayRemove;
exports.arrayUnion = commonFa1cc002_node.arrayUnion;
exports.collection = commonFa1cc002_node.collection;
exports.collectionGroup = commonFa1cc002_node.collectionGroup;
exports.connectFirestoreEmulator = commonFa1cc002_node.connectFirestoreEmulator;
exports.deleteDoc = commonFa1cc002_node.deleteDoc;
exports.deleteField = commonFa1cc002_node.deleteField;
exports.doc = commonFa1cc002_node.doc;
exports.documentId = commonFa1cc002_node.documentId;
exports.endAt = commonFa1cc002_node.endAt;
exports.endBefore = commonFa1cc002_node.endBefore;
exports.getDoc = commonFa1cc002_node.getDoc;
exports.getDocs = commonFa1cc002_node.getDocs;
exports.getFirestore = commonFa1cc002_node.getFirestore;
exports.increment = commonFa1cc002_node.increment;
exports.initializeFirestore = commonFa1cc002_node.initializeFirestore;
exports.limit = commonFa1cc002_node.limit;
exports.limitToLast = commonFa1cc002_node.limitToLast;
exports.or = commonFa1cc002_node.or;
exports.orderBy = commonFa1cc002_node.orderBy;
exports.query = commonFa1cc002_node.query;
exports.queryEqual = commonFa1cc002_node.queryEqual;
exports.refEqual = commonFa1cc002_node.refEqual;
exports.serverTimestamp = commonFa1cc002_node.serverTimestamp;
exports.setDoc = commonFa1cc002_node.setDoc;
exports.setLogLevel = commonFa1cc002_node.setLogLevel;
exports.snapshotEqual = commonFa1cc002_node.snapshotEqual;
exports.startAfter = commonFa1cc002_node.startAfter;
exports.startAt = commonFa1cc002_node.startAt;
exports.terminate = commonFa1cc002_node.terminate;
exports.updateDoc = commonFa1cc002_node.updateDoc;
exports.vector = commonFa1cc002_node.vector;
exports.where = commonFa1cc002_node.where;
exports.AggregateField = AggregateField;
exports.AggregateQuerySnapshot = AggregateQuerySnapshot;
exports.Transaction = Transaction;
exports.WriteBatch = WriteBatch;
